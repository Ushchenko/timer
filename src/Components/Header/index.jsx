      ...
      <header className="header">
        <div className="header__nav">
          <div className="header__left">
            <Link className="logo" to={"/Countdown"}>
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-apple-music" viewBox="0 0 16 16">
...
{/* <button className="btn">
  <span className="btn__svg__container">
