      ...
      <div className='calendar__scene'>
        <ul className="scene__month">
          <li className='carret prev'>
            <button onClick={prevMonth}>
              <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" fill="currentColor" className="bi bi-caret-up-fill" viewBox="0 0 16 16">
          ...
          <li className='carret next'>
            <button onClick={nextMonth}>
              <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" fill="currentColor" className="bi bi-caret-down-fill" viewBox="0 0 16 16">
        ...
        <div className='scene__weeks'>
          ...
          <ul className="scene__days" ref={parent}>
            <CountCalendarDays nowDate={nowDate} year={nowYear} month={nowMonth} />
          </ul>
        </div>
      </div>
    </section>
